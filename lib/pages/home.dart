...
import 'shop_cart.dart'; // Import the shop_cart.dart file
          ...
          children: [
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    // Navigate to shop_cart.dart when shopping cart icon is clicked
                    Navigator.push(
                      context,
            ...
            SizedBox(height: 20,),
            Text("PillPal", style: AppWidget.headerTextFieldStyle()),
            Text("By Reelabs India", style: AppWidget.tagLineTextFieldStyle()),
            SizedBox(height: 20,),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        ...
        children: [
          ...
          // GestureDetector for Essentials
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8.0),
            child: GestureDetector(
              onTap: () {
